    ...
    <div className='mt-2 flex space-x-4'>
      <div className='flex items-center justify-center'>
        ...
        >
          <button
            onClick={() => {
              copy('zhangbaolin.work@foxmail.com').then(() => {
...
const footerLinks: { href: string; text: string; tooltip: React.ReactNode }[] =
  [
    // {
    //   href: 'https://github.com/bowling00/blog',
    //   text: 'Source Code',
    //   tooltip: (
    //     <>
...
const socials: Social[] = [
  {
    href: 'https://github.com/bowling00',
    icon: SiGithub,
    id: 'Github',
    text: (
      <>
  ...
  {
    href: 'https://space.bilibili.com/519295997',
    icon: SiBilibili,
    id: 'Bilibili',
    text: (
      <>
  ...
  {
    href: 'https://space.bilibili.com/3546631402162997',
    icon: SiBilibili,
    id: 'Bilibili',
    text: (
      <>
